...
const TrainingImages = () => {
  return (
    ...
    TRAINING- OUR FOUNDATION SWIMMERS
      ...
      <div className='flex flex-col items-center'>
            ...
            <NavLink to='/gallery' className='hover:bg-white hover:text-black hover:border-2 px-2 py-1 rounded-4xl hover:scale-110 transition-all duration-150'>
            &#8592;
            </NavLink>
            </div>
          </div>
