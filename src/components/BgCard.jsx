...
export default function BgCard({nav,text,btnClass, btnText}){
    return (
        ...
        <div className="relative h-110 w-80 rounded-3xl">
            ...
            <div className="absolute h-full w-full backdrop-blur-3xl bg-black/30 rounded-3xl flex justify-center items-center">
            ...
            <NavLink className={`${btnClass} my-10 bg-gray-300 px-15 py-2 text-lg font-bold text-[#041E42] rounded-md transform transform-all duration-150 hover:scale-110`} to={nav}>View Images</NavLink>
                </div>
            </div>
