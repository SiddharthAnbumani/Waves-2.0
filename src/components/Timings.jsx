export default function Timings(){
    ...
    <div className="relative w-[800px] h-[400px] rounded-xl overflow-hidden bg-gray-50">
      ...
      {/* Overlay with text */}
      <div className="absolute inset-0 bg-opacity-40 flex flex-col justify-start items-center p-6 backdrop-blur-3xl text-black bg-gray-50 shadow-2xl">
        <p className="text-[#041E42] text-xl font-extrabold text-center mb-6">
        ...
        <div className="flex w-full h-full justify-center gap-4">
          {/* Morning batch */}
          <div className="w-1/2 h-fit py-6 px-4 border rounded-xl shadow">
            <ul className="text-[#041E42] flex flex-col items-center space-y-3 text-xl font-bold ">
